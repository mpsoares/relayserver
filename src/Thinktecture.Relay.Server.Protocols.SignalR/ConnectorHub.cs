...
namespace Thinktecture.Relay.Server.Protocols.SignalR
{
	...
	internal class ConnectorHub<TRequest, TResponse> : Hub<IConnector<TRequest>>, Connector.IConnectorTransport<TResponse>
		where TRequest : IRelayClientRequest
		where TResponse : IRelayTargetResponse
	{
		...
		public override async Task OnConnectedAsync()
		{
			...
			// TODO maybe IConnectorTransport created here?
		...
		public Task DeliverAsync(IRelayTargetResponse response)
		{
			throw new NotImplementedException();
		}
	}
